namespace Fluid.UI.Windows.Behaviors.UI.DragDrop.Icons
{
    /// <summary>
    ...
    public static class IconFactory
    {
        ...
        {
            var uri = new Uri($@"pack://application:,,,/Fluid.Design.UI;component/Behavior/UI/DragDrop/Icons/{iconName}", UriKind.RelativeOrAbsolute);

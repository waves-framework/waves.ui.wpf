using Fluid.UI.Windows.Behaviors.UI.DragDrop.Icons;
using Fluid.UI.Windows.Behaviors.UI.DragDrop.Utilities;
    ...
    public static partial class DragDrop
    {
      ...
      borderFactory.SetValue(TextOptions.TextHintingModeProperty, TextHintingMode.Fixed);
        ...
        private static void DoMouseButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            if ((System.Windows.Input.Keyboard.Modifiers & ModifierKeys.Shift) == 0 && (System.Windows.Input.Keyboard.Modifiers & ModifierKeys.Control) == 0 && m_DragInfo.VisualSourceItem != null && itemsControl != null && itemsControl.CanSelectMultipleItems())
            {
        ...
        private static void DoMouseButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            if (itemsControl != null && dragInfo != null && m_ClickSupressItem != null && m_ClickSupressItem == dragInfo.SourceItem)
            {
                ...
                else if ((System.Windows.Input.Keyboard.Modifiers & ModifierKeys.Shift) == 0)
                {
        ...
        private static void DropTargetOnGiveFeedback(object sender, GiveFeedbackEventArgs e)
        {
            if (EffectAdorner != null)
            {
                ...
                e.Handled = true;
                if (System.Windows.Input.Mouse.OverrideCursor != Cursors.Arrow)
                {
        ...
        private static System.Windows.Size _adornerSize;
    }
}
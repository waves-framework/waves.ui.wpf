...
namespace Waves.UI.Windows.Controls.Drawing.ViewModel
{
    /// <summary>
    ...
    public class DrawingElementViewModel : PresentationViewModel, IDrawingElementViewModel
    {
        ...
        protected virtual void OnInputServicePointerStateChanged(object sender, Waves.Core.Base.EventArgs.PointerEventArgs e)
        {
        }

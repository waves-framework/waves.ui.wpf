...
namespace Waves.UI.Windows.Services
{
    ...
    public class ThemeService : Waves.Core.Base.Service, IThemeService
    {
        ...
        private const string AccentBlackColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Black.xaml";
        private const string AccentBlueColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Blue.xaml";
        private const string AccentGreenColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Green.xaml";
        private const string AccentRedColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Red.xaml";
        private const string AccentYellowColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Yellow.xaml";

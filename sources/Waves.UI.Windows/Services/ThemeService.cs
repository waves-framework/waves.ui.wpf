...
namespace Waves.UI.Windows.Services
{
    /// <summary>
    ...
    public class ThemeService : Waves.Core.Base.Service, IThemeService
    {
        ...
        private const string PrimaryLightColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Primary.Light.xaml";
        private const string PrimaryDarkColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Primary.Dark.xaml";
        private const string AccentWhiteColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.White.xaml";
        private const string AccentBlackColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Haiti.xaml";
        private const string AccentBlueColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Picton.Blue.xaml";
        private const string AccentGreenColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Jade.xaml";
        private const string AccentRedColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Sunset.Orange.xaml";
        private const string AccentYellowColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Ronchi.xaml";
        private const string AccentTemplateDictionaryUri = "/Waves.UI.Windows;component/Colors/Accent.Template.xaml";
        private const string MiscellaneousColorsDictionaryUri = "/Waves.UI.Windows;component/Colors/Miscellaneous.Classic.xaml";
